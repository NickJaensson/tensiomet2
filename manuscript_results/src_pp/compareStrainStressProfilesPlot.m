function [] = compareStrainStressProfilesPlot(InputDataStruc, InputVarList, subpl)
...
for i = 1:size(InputVarList,2)
    ...
    strain_dil = InputDataStruc.(InputVarList{1,i}).DefSt_fwd.lams.*InputDataStruc.(InputVarList{1,i}).DefSt_fwd.lamp;
    % find shear strain along arc length
    strain_shr = InputDataStruc.(InputVarList{1,i}).DefSt_fwd.lams./InputDataStruc.(InputVarList{1,i}).DefSt_fwd.lamp;
    % make plots
...
if strain == 0.80
    if Wo == 1 && Ar == 5
        ...
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.62 0.76]);
    elseif Wo == 0.1 && Ar == 5
        img = imread('Img_Ar5.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.62 0.69]);
    elseif Wo == 1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.62 0.684]);
    elseif Wo == 0.1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.62 0.652]);
    end
elseif strain == 0.90
    if Wo == 1 && Ar == 5
        img = imread('Img_Ar5.png');
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.8 0.87]);
    elseif Wo == 0.1 && Ar == 5
        img = imread('Img_Ar5.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.8 0.835]);
    elseif Wo == 1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.8 0.832]);
    elseif Wo == 0.1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.8 0.816]);
    end
elseif strain == 0.95
    if Wo == 1 && Ar == 5
        img = imread('Img_Ar5.png');
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.9 0.935]);
    elseif Wo == 0.1 && Ar == 5
        img = imread('Img_Ar5.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.9 0.918]);
    elseif Wo == 1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.605 0.995],'ydata',[0.9 0.916]);
    elseif Wo == 0.1 && Ar == 1
        img = imread('Img_Ar1.png');
        img = flipud(img);
        image(img,'xdata',[0.7 0.9],'ydata',[0.9 0.908]);
    end
end
...
ttl = title(strcat({strcat(col, 'Wo=', num2str(Wo), ', Ar=', num2str(Ar), ',') ; ...
...
xlabel('Dimensionless arc length, $\hat{s}$ [ ]', 'interpreter', 'latex');
