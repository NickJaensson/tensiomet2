function [] = getDilParamPlot(DataStruc, VarList, DilParam_table, X, Y, subpl)
...
MyMap = brewermap(21, 'BrBG'); MyMap = MyMap(11:21,:);
...
ttl = title(strcat({strcat(col, '\textbf{DAP:} Wo=', num2str(Wo), ', Ar=', num2str(Ar), ',') ; ...
