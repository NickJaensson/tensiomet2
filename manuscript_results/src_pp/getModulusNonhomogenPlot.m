function [] = getModulusNonhomogenPlot(DataStruc, VarList, ModulusTable, X, Y, subpl)
...
TMet_subpltitle = strcat(col1, 'SFE: Strain=', strainlabel, '\%');
...
MyMap = brewermap(11, 'RdBu'); MyMap = flipud(MyMap);
...
sgtitle(strcat('Dilatational Modulus Nonhomogeneity: Wo=', num2str(Wo), ', Ar=', num2str(Ar), ...
