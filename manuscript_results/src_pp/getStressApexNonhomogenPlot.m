function [] = getStressApexNonhomogenPlot(DataStruc, VarList, ApexStressTable, X, Y, subpl)
...
MyMap = brewermap(11, 'PiYG'); MyMap = flipud(MyMap);
...
sgtitle(strcat('Apical Stress Nonhomogeneity: Wo=', num2str(Wo), ', Ar=', num2str(Ar), ...
